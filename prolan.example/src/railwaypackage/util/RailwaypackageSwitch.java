 ...
 * @generated
 */
public class RailwaypackageSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RailwaypackagePackage.RAILWAY_LAYOUT: {
				RailwayLayout railwayLayout = (RailwayLayout)theEObject;
				T result = caseRailwayLayout(railwayLayout);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RailwaypackagePackage.SEGMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Railway Layout</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Railway Layout</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRailwayLayout(RailwayLayout object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Railway Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Railway Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
